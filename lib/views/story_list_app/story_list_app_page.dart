...
class StoryListAppPage extends StatefulWidget {
  @override
  _StoryListAppPageState createState() => _StoryListAppPageState();
}
...
class _StoryListAppPageState extends State<StoryListAppPage> {
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Stack(
                children: <Widget>[
                  StoryCardScrollWidget(currentPage),
                  Positioned.fill(
              ...
              Row(
                children: <Widget>[
                  Padding(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(20.0),
                      child: Image.asset("assets/story_image_02.jpg",
...
class StoryCardScrollWidget extends StatelessWidget {
  ...
  StoryCardScrollWidget(this.currentPage);
