...
class VideoForumNameWidget extends StatelessWidget {

  final VideoForum forum;
  VideoForumNameWidget({this.forum});
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      elevation: 20.0,
      shape: VideoCustomShapeBorder(),
      child: Padding(
        padding: EdgeInsets.only(top: 18.0, left: 20.0, right: 16.0, bottom: 5.0),
        child: Text(
          forum.title,
          style: VideoTextStyles.forumNameTextStyle,
        ),
      ),
    );
  }
...
class VideoCustomShapeBorder extends ShapeBorder {
